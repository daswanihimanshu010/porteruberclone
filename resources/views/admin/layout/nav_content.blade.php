...
{{-- Units --}}
@can('list peakHours')
<x-nav.droplist title="{{ __('crud.admin.units.name') }}" href="togglePeakHoursMenu" icon="clock-o"
    :active="request()->routeIs(['admin.unit.*'])">
    <x-nav.droplink href="{{ route('admin.unit.index') }}">{{ __('crud.admin.units.index') }}
    </x-nav.droplink>
    <x-nav.droplink href="{{ route('admin.unit.create') }}">{{ __('crud.admin.units.create') }}
    </x-nav.droplink>
</x-nav.droplist>
@endcan
