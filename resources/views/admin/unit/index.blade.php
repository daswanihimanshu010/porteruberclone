...
@section('title')
    Admin - {{ __('crud.admin.units.index') }}
@endsection

@section('heading')
    {{ __('crud.admin.units.index') }}
@endsection

@section('content')
    <x-indexPageSearch :addBtnRoute="route('admin.unit.create')" :addBtnText="__('crud.admin.units.create')"></x-indexPageSearch>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td>
                                <div class="flex items-center justify-center">
                                    {{-- <x-buttons.show :link="route('admin.admin.show', $unit)"></x-buttons.show> --}}
                                    <x-buttons.edit :link="route('admin.unit.edit', $unit)"></x-buttons.edit>
                                    <x-buttons.delete :link="route('admin.unit.destroy', $unit)"></x-buttons.delete>
                                </div>
                            </td>
                        </tr>
                    @empty
